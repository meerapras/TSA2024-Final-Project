...
raw_temp<-read.csv(here('Data/Raw/temp_1990-2024.csv'),stringsAsFactors = TRUE,skip=5,header=FALSE)
raw_preci<-read.csv(here('Data/Raw/precipitation_1990-2024.csv'),stringsAsFactors = TRUE,skip=5,header=FALSE)
```
